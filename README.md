...
- **Commentary regimes**: Chess commentary is supplied by [Synthetic Commentary Generation](https://github.com/jdoughty04/Synthetic_commentary_generation) and potentially[Chessvisor](https://github.com/jdoughty04/chessvisor). Using LLM augmented tools, we can curate multiple viable training curricula, from low-entropy factoids to chatbot-style Q&A/coaching.
